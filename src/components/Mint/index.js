...
const Mint = () => {
  ...
  return (
    <div className={'flex flex-col items-center'}>
      ...
      <div className={'text-xl md:text-3xl'}>{`Mint price (0.1Eth + Gas)`}</div>
      <div className={'text-xl md:text-3xl mb-5 text-center'}>Maximum of {maxMint} OXPGodjira per wallet</div>
      {
        wallet.isConnected() ?
          (
